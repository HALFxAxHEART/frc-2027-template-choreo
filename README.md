...
## This branch: `pickplace-elevator`

Adds an **elevator + gripper** (2025 Reefscape-style pick-and-place). Operator (port 1): **A/B/Y** = stow/low/high; hold **LB** to intake, **RB** to eject.
